---
name: abordar-tarea
description: Implement a development task from requirements, with proportionate exploration, behavior tests and a final review against each requirement. Use when building or fixing functionality; not for read-only questions or running the agent evaluator.
---
