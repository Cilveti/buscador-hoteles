...
Validación local del cambio: 21 tests / 73 aserciones, TypeScript del arnés, Biome y actionlint verdes. No hay nuevas dependencias. La [baseline remota 35075197928](https://github.com/Cilveti/buscador-hoteles/actions/runs/35075197928), commit `e1de026`, también terminó verde: contratos, resolución aislada, checks de aplicación, navegador y build. Esta baseline no invoca modelos; la integración completa del nuevo transporte no se había ejecutado en esta comparación inicial. Los ensayos posteriores y el estado vigente están en [EVIDENCE.md](EVIDENCE.md). [Medición](evidence/structured-baseline-35075197928.json).
