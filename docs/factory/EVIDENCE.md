...
- Primera baseline: PostgreSQL 16.15. Corrección posterior: imagen con PostgreSQL 17.11, igual que compose local, servidor y cliente fijados a `17.11-1.pgdg24.04+2`. Los 10 E2E pasan localmente en 20,5 s con esta versión; queda su baseline remota.
...
- Controladores con recuperación/CAS/medición publicados en `509c349`; baseline `35031262510` en curso, permite observar la caché.
...
- 14 tests del arnés / 47 aserciones verdes. Contratos TypeScript y YAML validados. Estas pruebas son deterministas, no ejecuciones de modelos.
