...
6. Cuando aparezca la PR en borrador, leer «Qué cambia», «Qué se ha comprobado» y «Calidad de código». Revisar el diff y la intención. Si GitHub muestra **Approve workflows to run**, aprobar esa CI adicional y esperar sus resultados antes de decidir la integración; aprobar una ejecución no aprueba el código.
